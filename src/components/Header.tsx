...
export default function Header({
  ...
  async function handleSaveEmail() { setSavingEmail(true); setEmailMsg(''); try { await updateMyEmail(newEmail); setEmailMsg(lang === 'de' ? '✓ Bestätigungslink gesendet' : '✓ Confirmation link sent' : '✓ Confirmation link sent — check your email'); } catch (e: any) { setEmailMsg(`Error: ${e.message}`); } finally { setSavingEmail(false); } }
