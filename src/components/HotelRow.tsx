        ...
        {isOpen && (
          <div className={cn('rounded-b-2xl border-t shadow-inner flex flex-col', dk ? 'bg-[#0B1224] border-white/5' : 'bg-slate-50 border-slate-200')} onClick={e => e.stopPropagation()}>
            ...
            {activeTab === 'info' && (() => {
               ...
               return (
                 <div className="flex flex-col gap-5 p-5 bg-white dark:bg-[#0B1224] rounded-b-2xl border-t border-slate-200 dark:border-white/5 animate-in fade-in">
                    ...
                    {/* ROW 3: NOTES TEXTAREA (Conditional) */}
                    {showNotes && (
