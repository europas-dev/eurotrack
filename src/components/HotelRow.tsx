        ...
        <div className="px-4 py-3">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="flex items-center gap-3 min-w-0 flex-1 overflow-x-auto scrollbar-thin">
              ...
              <span className={cn(
                'px-2 py-1 rounded-full text-[10px] font-bold whitespace-nowrap flex-shrink-0',
          ...
          <div className={cn(
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <input list={`company-list-${localHotel.id}`} className={inputCls} value={localHotel.companyTag || ''} onChange={e => patchHotel({ companyTag: e.target.value })} placeholder={lang === 'de' ? 'Firma / Tag...' : 'Company / tag...'} />
